...
public class FirePoison : PoisonSpreadBehaviour
{
	...
	{
		CirculationBehaviour circulationBehaviour = this.Limb.CirculationBehaviour;
		SkinMaterialHandler skinMaterialHandler = this.Limb.SkinMaterialHandler;
		PhysicalBehaviour physicalBehaviour = this.Limb.PhysicalBehaviour;
		physicalBehaviour.Ignite(true);
	}
}
